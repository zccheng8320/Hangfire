...
function loadManagement() {
    ...
    link.setAttribute("href", 'https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/4.17.47/css/bootstrap-datetimepicker.min.css');
    document.getElementsByTagName("head")[0].appendChild(link);
    var url = "https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/4.17.47/js/bootstrap-datetimepicker.min.js";
    $.getScript(url,
        function () {
            $(function () {
                $("div[id$='_datetimepicker']").datetimepicker({ format: "YYYY-MM-DD HH:mm:ss" });
                $("input.date").datetimepicker({ format: "YYYY-MM-DD HH:mm:ss" });         
                $("div[id$='_datepicker']").datetimepicker({ format: "YYYY-MM-DD" });
            });
        });
